...
// Saran default search — hanya halaman ARKA MMS
    ...
    suggestions: [
      {
        ...
        suggestion: 'Maintenance Dashboard',
    ...
    suggestions: [
      {
        ...
        suggestion: 'Maintenance Plans',
        link: '/apps/maintenance-plan/list'
      },
      {
        icon: 'tabler:clipboard-check',
        suggestion: 'Maintenance Actuals',
        link: '/apps/maintenance-actual/list'
      },
      {
        icon: 'tabler:tool',
        suggestion: 'Maintenance Types',
        link: '/apps/maintenance-type/list'
      },
      {
        icon: 'tabler:truck',
        suggestion: 'Units',
      ...
      <List sx={{ py: 0 }}>
        <ListItem sx={{ py: 2 }} disablePadding onClick={() => setOpenDialog(false)}>
          ...
          >
            ...
            <Typography>Maintenance Dashboard</Typography>
          </Box>
        </ListItem>
        <ListItem sx={{ py: 2 }} disablePadding onClick={() => setOpenDialog(false)}>
          <Box
        ...
        <ListItem sx={{ py: 2 }} disablePadding onClick={() => setOpenDialog(false)}>
          <Box
            component={Link}
            href='/apps/maintenance-plan/list'
            sx={{
              display: 'flex',
              alignItems: 'center',
              textDecoration: 'none',
          ...
          >
            ...
            <Typography>Maintenance Plans</Typography>
          </Box>
        </ListItem>
      </List>
    </Box>
